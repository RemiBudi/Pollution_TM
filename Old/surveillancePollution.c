...
void inputTroisCapteurs(){
    ...
    for(int i=0; i<3; i++){
        temperature[i] = float_rand(9.0,10.0);
    }
...
void detectionPollution(float moyenneT, float moyenneO, float moyenneP){

    //True si il y a pollution
    bool pollution;
